...
bool8 Task_ProcessSoundCheckMenuInput(u8 taskId)
{
    ...
    else if (gMain.newAndRepeatedKeys & DPAD_RIGHT)
    {
        ...
        else
        {
            if (gTasks[taskId].tBgmIndex > 0)
                ...
                gTasks[taskId].tBgmIndex = (MUS_RG_TVNOIZE - MUS_STOP);
        }
        return TRUE;
    }
    else if (gMain.newAndRepeatedKeys & DPAD_LEFT)
    {
        ...
        {
            if (gTasks[taskId].tBgmIndex < MUS_RG_TVNOIZE - MUS_STOP)
                gTasks[taskId].tBgmIndex++;
            else
                gTasks[taskId].tBgmIndex = 0;
        }
...
X(MUS_RG_KAIHUKU, "KAIHUKU") \
X(MUS_RG_CYCLING, "CYCLING") \
X(MUS_RG_ROCKET, "ROCKET") \
X(MUS_RG_SHOUJO, "SHOUJO") \
X(MUS_RG_SHOUNEN, "SHOUNEN") \
X(MUS_RG_DENDOU, "DENDOU") \
X(MUS_RG_T_MORI, "T-MORI") \
X(MUS_RG_OTSUKIMI, "OTSUKIMI") \
X(MUS_RG_POKEYASHI, "POKEYASHI") \
X(MUS_RG_ENDING, "RG-END") \
X(MUS_RG_LOAD01, "LOAD01") \
X(MUS_RG_OPENING, "RG-OPEN") \
X(MUS_RG_LOAD02, "LOAD02") \
X(MUS_RG_LOAD03, "LOAD03") \
X(MUS_RG_CHAMP_R, "CHAMP-R") \
X(MUS_RG_VS_GYM, "RGVS-GYM") \
X(MUS_RG_VS_TORE, "RGVS-TORE") \
X(MUS_RG_VS_YASEI, "RGVS-YASEI") \
X(MUS_RG_VS_LAST, "RGVS-LAST") \
X(MUS_RG_MASARA, "MASARA") \
X(MUS_RG_KENKYU, "KENKYU") \
X(MUS_RG_OHKIDO, "OHKIDO") \
X(MUS_RG_POKECEN, "POKECEN") \
X(MUS_RG_SANTOAN, "SANTOAN") \
X(MUS_RG_NAMINORI, "NAMINORI") \
X(MUS_RG_P_TOWER, "P-TOWER") \
X(MUS_RG_SHIRUHU, "SHIRUHU") \
X(MUS_RG_HANADA, "HANADA") \
X(MUS_RG_TAMAMUSI, "TAMAMUSI") \
X(MUS_RG_WIN_TRE, "WIN-TRE") \
X(MUS_RG_WIN_YASEI, "WIN-YASEI") \
X(MUS_RG_WIN_GYM, "WIN-GYM") \
X(MUS_RG_KUCHIBA, "KUCHIBA") \
X(MUS_RG_NIBI, "NIBI") \
X(MUS_RG_RIVAL1, "RIVAL1") \
X(MUS_RG_RIVAL2, "RIVAL2") \
X(MUS_RG_FAN2, "FAN2") \
X(MUS_RG_FAN5, "FAN5") \
X(MUS_RG_FAN6, "FAN6") \
X(MUS_RG_PHOTO, "PHOTO") \
X(MUS_RG_TITLEROG, "TITLEROG") \
X(MUS_RG_GET_YASEI, "GET-YASEI") \
X(MUS_RG_SOUSA, "SOUSA") \
X(MUS_RG_SEKAIKAN, "SEKAIKAN") \
X(MUS_RG_SEIBETU, "SEIBETU") \
X(MUS_RG_JUMP, "JUMP") \
X(MUS_RG_UNION, "UNION") \
X(MUS_RG_NETWORK, "NETWORK") \
X(MUS_RG_OKURIMONO, "OKURIMONO") \
X(MUS_RG_KINOMIKUI, "KINOMIKUI") \
X(MUS_RG_NANADUNGEON, "NANADUNGEON") \
X(MUS_RG_OSHIE_TV, "OSHIE-TV") \
X(MUS_RG_NANASHIMA, "NANASHIMA") \
X(MUS_RG_NANAISEKI, "NANAISEKI") \
X(MUS_RG_NANA123, "NANA123") \
X(MUS_RG_NANA45, "NANA45") \
X(MUS_RG_NANA67, "NANA67") \
X(MUS_RG_POKEFUE, "POKEFUE") \
X(MUS_RG_VS_DEO, "VS-DEO") \
X(MUS_RG_VS_MYU2, "VS-MYU2") \
X(MUS_RG_VS_DEN, "VS-DEN") \
X(MUS_RG_EXEYE, "EXEYE") \
X(MUS_RG_DEOEYE, "DEOEYE") \
X(MUS_RG_T_TOWER, "T-TOWER") \
X(MUS_RG_SLOWMASARA, "SLOWMASARA") \
X(MUS_RG_TVNOIZE, "TVNOIZE")
